...
const RoomChatPanel = ({ room, currentUserId }) => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-white relative chat-panel overflow-hidden">
      ...
      >
        ...
        {loading && messages.length === 0 ? (
          ...
          <div className="flex-1 flex flex-col">
            <div className="flex-1 flex flex-col items-center justify-center text-gray-500 p-6 empty-chat-state">
              {getRoomIcon()}
      ...
      {/* Message Input - ALWAYS VISIBLE for all room types */}
      <div className="flex-shrink-0 bg-white chat-input-area">
        <UserMentionInput
